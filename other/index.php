    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function firePixelOnTelNrClick() {
				...
				console.log("firePixelOnTelNrClick");
				...
				*/
				...
				// Ajax form 
				$.post('test_analytics.php', $(this).serialize())
					.done( function ( data ) {
			...
			function firePixelOnTelNrClick_TEST() {
				
				alert("firePixelOnTelNrClick_TEST");
				...
				console.log("firePixelOnTelNrClick_TEST");
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-sm-offset-2 branch-sidebar">
                    ...
                    <div class="sidebar-module">
                        ...
                        <h3 class="universal-number"><a href="" id="test_call">Testing...</a></h3>
                    </div>
